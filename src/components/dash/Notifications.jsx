      ...
      <div className="border border-yellow-500 p-4 rounded-lg flex flex-col md:flex-row md:items-center gap-4 bg-white">
        ...
        <span>
          ...
          <small className="font-light text-xs">
            ...
            <Link className="text-green-600">2FA</Link> security.{" "}
          </small>
        </span>
      </div>
      <div className="border border-red-500 p-4 rounded-lg flex flex-col md:flex-row md:items-center gap-4 bg-white">
        ...
        <span>
          ...
          <small className="font-light text-xs">
            ...
            account. <Link className="text-green-600">Click here</Link> to
            submit KYC information. NOTE: Withdrawals are disabled until your
